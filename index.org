...
Denne overskriften er en kommentar. Det betyr at den ikke kommer med under eksport.
...
* Forskehre og ingeniørerer                                        :noexport:
...
* Grad av kaos                                                     :noexport:

Eller, "Beseiring av termodynamikkens andre lov". Eller bare "Entropi". "Entropi
i hverdagen"?
...
Relatert:
- Noen programmeringsspråk påtvinger innsats for å holde orden. Ofte typede
  språk.
  - Haskell :: Her må vi holde typene våre i orden. Grensesnitt må defineres og
               være klare, slik at de kan typesjekker.
  - Java :: Å sette ting i klasser er å sette ting i orden. Obs: klasser er en
            høyere abstraksjon enn typer, og krever at vi har forstått hva vi
            ønsker å løse tidlig. Dette er et problem!
  - COBOL :: Et tidlig forsøk på å få nok dokumentasjon? Må i alle fall skrive mye.
- Andre språk gir frihet. Disse er det gjerne raskere å komme igang med, men gir
  en større kneik å klatre når ting begynner å bli stort.
  - Python
  - Clojure
